...
export class LoginService {
    ...
    constructor(private router: Router, private http: HttpClient, private storageHelper: StorageHelperService) { }

    login(loginCredential: ILoginInterface) {
        this.storageHelper.setAsSession(StorageHelperConstant.email, loginCredential.email);
        this.http.post(this.loginApi, loginCredential, {
            ...
            next: (res: any) => {
                this.storageHelper.setAsSession(StorageHelperConstant.names, res.data);
