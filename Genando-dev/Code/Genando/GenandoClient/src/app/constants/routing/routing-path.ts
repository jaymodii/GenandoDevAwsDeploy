export class RoutingPathConstant {
  ...
  public static doctorDashboard = 'doctor/dashboard';
  public static doctorDashboardUrl = '/doctor/dashboard';

  public static patientDashboard = 'patient/dashboard';
  public static patientDashboardUrl = '/patient/dashboard';

  public static labDashboard = 'lab/dashboard';
  public static labDashboardUrl = '/lab/dashboard';
